...
const Loader = () => {
  ...
  <div className="relative w-32 h-32 rounded-full bg-watercolor border-[3px] border-white overflow-hidden shadow-inner animate-startround">
    ...
    <svg
      ...
      viewBox="0 0 200 200"
      className="absolute bottom-[-2em] w-28 animate-round1Delay"
    >
      <path
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
      className="absolute top-[-3em] w-28 animate-round1"
    >
      <path
        transform="translate(100 100)"
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
      className="absolute top-[-2.5em] w-28 animate-round2"
    >
      <path
        transform="translate(100 100)"
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 200 200"
      className="absolute bottom-[-2.2em] w-28 animate-round2Delay"
    >
      <path
        transform="translate(100 100)"
